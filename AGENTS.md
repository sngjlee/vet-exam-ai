...
|-- (Supabase config/schema/migrations live under vet-exam-ai/supabase/ — single tree since 2026-07-09)
...
| DB migrations | `vet-exam-ai/supabase/migrations/` | Single authoritative migration tree |
| Supabase config/schema | `vet-exam-ai/supabase/` | `config.toml`, `schema.sql` (relocated here 2026-07-09) |
...
- Do not recreate a migration tree at root `supabase/migrations/` (retired 2026-07-09); use `vet-exam-ai/supabase/migrations/` only.
