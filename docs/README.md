...
| 런칭 최종 QA / 스모크 테스트 | `docs/operations/launch-smoke-test.md` | 내부 |
...
| 문제은행 파이프라인 운영 루틴 | `docs/operations/question-bank-pipeline.md` | 내부 |
| 시딩 댓글 운영 기준 | `docs/operations/community-comment-seeding.md` | 내부 |
| 모더레이션 플레이북 | `docs/operations/moderation-playbook.md` | 내부 |
| 마이그레이션 런북 | `docs/operations/migration-runbook.md` | 내부 |
| 결제/프리미엄 준비 체크리스트 | `docs/operations/premium-readiness.md` | 내부 |
